...
export const whyChooseUs = [
  { title: "Global Certifications", description: "ISO, ZDHC, GOTS, and Bluesign certified processes.", icon: CheckCircle2 },
  { title: "Massive Capacity", description: "Over 20,000 tons of annual output across two countries.", icon: Factory },
  { title: "R&D Excellence", description: "Cutting-edge laboratories for custom product matching.", icon: FlaskConical },
  { title: "Eco-Friendly", description: "Committed to sustainable, green chemistry solutions.", icon: Leaf }
]
