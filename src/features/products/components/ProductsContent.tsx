        ...
        <div className="bg-primary text-primary-foreground py-20 relative overflow-hidden">
          ...
          <Container className="relative z-10 text-center">
            ...
            <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
              Explore our comprehensive range of sustainable textile auxiliary
              chemicals designed to optimize every stage of production.
            </p>
          </Container>
        </div>
      </CinematicSection>
              ...
              <main className="lg:col-span-3">
                <div className="mb-8">
                  <SectionTitle
                    title={
                      category
                        ? selectedCategory?.title ?? "Filtered Results"
                        : "All Products"
                    }
                    subtitle={
                      category
                        ? `Showing ${filteredProducts.length} products in ${
                            selectedCategory?.title ?? "this category"
                          }`
