          ...
          {categoriesData.map((category) => (
            <AnimatedContainer key={category.id} animation="stagger-item" className="h-full">
              <TiltCard tiltAmount={12} scaleAmount={1.05} className="h-full">
                ...
                >
                  <div className="absolute inset-0 bg-linear-to-br from-secondary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div className="relative z-10 flex items-center gap-4 mb-6">
                    <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-secondary text-primary-foreground shrink-0 shadow-[0_0_15px_rgba(217,155,34,0.4)] group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="flex items-center text-sm font-bold text-secondary group-hover:text-secondary transition-colors mt-auto relative z-10">
